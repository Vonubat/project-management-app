...
import { BadRequest, LoginAlreadyExist, UserWasNotFound } from 'types/badRequests';
...
export default class UsersService {
  ...
  static getUser(userId: string): Promise<AxiosResponse<UserData | UserWasNotFound>> {
  ...
  ): Promise<AxiosResponse<UserData | BadRequest | LoginAlreadyExist>> {
